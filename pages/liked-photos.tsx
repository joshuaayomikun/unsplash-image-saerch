...
export default function LikePhotos() {
    const { user, error: userError } = useContext(AuthContext)
    const { data: myLikes, mutate: _mutateMyLikes, error: myLikesError } = useSWR<Basic[]>(typeof user === "undefined" ? null : user.links.likes)
